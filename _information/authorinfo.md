...
- There should be no links to external websites (e.g. YouTube, github, authors institute pages) in the blinded submission. Links to external resources can be provided in the final camera-ready version of the paper.
...
- **Logging into the system:** If you already have an OpenReview account, use those credentials to login. If you do not, sign up as a new user.
- **Conflict domains:** When you login for the first time, OpenReview will prompt you to enter your conflict domains. Please finish this step before you start the submission process.
