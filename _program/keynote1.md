...
<td width="60%" height="120px;">
    <center><span  style="font-size:26px; vertical-align: top; ">Monday, July 12</span></center><br>
</td>
<td style="width: 15%; text-align: center;"><a href="{{ site.baseurl }}/program/keynote2/">
...
<script>
var startDate1 = new Date("2021-07-12 09:30:00 UTC-0700").getTime();
var finDate1 = new Date("2021-07-12 10:00:00 UTC-0700").getTime();
...
<script>
var startDate2 = new Date("2021-07-12 19:00:00 UTC-0700").getTime();
var finDate2 = new Date("2021-07-12 19:30:00 UTC-0700").getTime();
