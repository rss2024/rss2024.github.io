...
<table id="myTable">
  ...
  <tr>
    <td>Grasping</td>
    <td>
      SpringGrasp: Synthesizing Compliant, Dexterous Grasps under Shape Uncertainty <hr>
...
<tr>
  <td>Navigation</td>
  <td>
    GOAT: GO to Any Thing <hr>
    Demonstrating Arena 3.0: Advancing Social Navigation in Collaborative and Highly Dynamic Environments <hr>
    RAG-Driver: Generalisable Driving Explanations with Retrieval-Augmented In-Context Multi-Modal Large Language Model Learning <hr>
    Dynamic Adversarial Attacks on Autonomous Driving Systems <hr>
    Hierarchical Open-Vocabulary 3D Scene Graphs for Language-Grounded Robot Navigation <hr>
    ScrewMimic: Bimanual Imitation from Human Videos with Screw Space Projection <hr>
    NaVid: Video-based VLM Plans the Next Step for Vision-and-Language Navigation <hr>
...
<tr>
  ...
  <td>
    Khronos: A Unified Approach for Spatio-Temporal Metric-Semantic SLAM in Dynamic Environments <hr>
    Demonstrating Agile Flight from Pixels without State Estimation <hr>
    You’ve Got to Feel It To Believe It: Multi-Modal Bayesian Inference for Semantic and Property Prediction <hr>
    AnyFeature-VSLAM: Automating the Usage of Any Feature into Visual SLAM <hr>
    iMESA: Incremental Distributed Optimization for Collaborative Simultaneous Localization and Mapping <hr>
    Scalable Distance-based Multi-Agent Relative State Estimation via Block Multiconvex Optimization <hr>
    Experience-based multi-agent path finding with narrow corridors <hr>
...
<tr>
  <td>Robot Learning Foundation Models</td>
  <td>
    Explore until Confident: Efficient Exploration for Embodied Question Answering <hr>
    Octo: An Open-Source Generalist Robot Policy <hr>
    Demonstrating OK-Robot: What Really Matters in Integrating Open-Knowledge Models for Robotics <hr>
    Any-point Trajectory Modeling for Policy Learning <hr>
    Pushing the Limits of Cross-Embodiment Learning for Manipulation and Navigation <hr>
    Language Model Guided Sim-To-Real Transfer <hr>
    "Set It Up!'': Functional Object Arrangement with Compositional Generative Models <hr>
...
<tr>
  <td>Robot Design</td>
  <td>
    ConTac: Continuum-Emulated Soft Skinned Arm with Vision-based Shape Sensing and Contact-aware Manipulation <hr>
    Function Based Sim-to-Real Learning for Shape Control of Deformable Free-form Surfaces <hr>
    Safe & Accurate at Speed with Tendons: A Robot Arm for Exploring Dynamic Motion <hr>
    Evolution and learning in differentiable robots <hr>
    Construction of a Multiple-DOF Underactuated Gripper with Force-Sensing via Deep Learning <hr>
    A Single Motor Nano Aerial Vehicle with Novel Peer-to-Peer Communication and Sensing Mechanism <hr>
...
<tr>
  <td>Control</td>
  <td>
    POLICEd RL: Learning Closed-Loop Robot Control Policies with Provable Satisfaction of Hard Constraints <hr>
    Demonstrating Language-Grounded Motion Controller <hr>
    VLMPC: Vision-Language Model Predictive Control for Robotic Manipulation <hr>
    Expressive Whole-Body Control for Humanoid Robots <hr>
    From Compliant to Rigid Contact Simulation: a Unified and Efficient Approach <hr>
    Time-Optimal Flight with Safety Constraints and Data-driven Dynamics <hr>
    Linear-time Differential Inverse Kinematics: an Augmented Lagrangian Perspective <hr>
...
<tr>
  <td>Planning</td>
  <td>
    AutoGPT+P: Affordance-based Task Planning using Large Language Models <hr>
    Implicit Graph Search for Planning on Graphs of Convex Sets <hr>
    Real-Time Anomaly Detection and Reactive Planning with Large Language Models <hr>
    iHERO: Interactive Human-oriented Exploration and Supervision Under Scarce Communication <hr>
    Who Plays First? Optimizing the Order of Play in Stackelberg Games with Many Robots <hr>
    Goal-Reaching Trajectory Design Near Danger with Piecewise Affine Reach-avoid Computation <hr>
    Partially Observable Task and Motion Planning with Uncertainty and Risk Awareness <hr>
...
<tr>
  <td>Imitation Learning</td>
  <td>
    DROID: A Large-Scale In-The-Wild Robot Manipulation Dataset <hr>
    Multimodal Diffusion Transformer: Learning Versatile Behavior from Multimodal Goals <hr>
    Don't Start From Scratch: Behavioral Refinement via Interpolant-based Policy Diffusion <hr>
    Learning Manipulation by Predicting Interaction <hr>
    URDFormer: A Pipeline for Constructing Articulated Simulation Environments from Real-World Images <hr>
    Learning to Learn Faster from Human Feedback with Language Model Predictive Control <hr>
    Natural Language Can Help Bridge the Sim2Real Gap <hr>
...
<tr>
  <td>Manipulation</td>
  <td>
    Tilde: Teleoperation for Dexterous In-Hand Manipulation Learning with a DeltaHand <hr>
    Spatially-Grounded Motion Primitives for Manipulation <hr>
    RoboPack: Learning Tactile-Informed Dynamics Models for Dense Packing <hr>
    Configuration Space Distance Fields for Manipulation Planning <hr>
    Towards Tight Convex Relaxations for Contact-Rich Manipulation <hr>
    THE COLOSSEUM: A Benchmark for Evaluating Generalization for Robotic Manipulation <hr>
    One-Shot Imitation Learning with Invariance Matching for Robotic Manipulation <hr>
